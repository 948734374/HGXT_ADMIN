...
<html>
	...
	<body class="hold-transition skin-blue sidebar-mini mc_body">
						...
						<div class="box-header" style="line-height: 45px;">
							...
							<div class="form-inline" style="margin: 10px 0 0 0;">
								<div class="form-group">
									...
									<select id="labourStatus" class="form-control" onchange="getLabour();">
								...
								<div class="form-group">
									<input type="text" id="adminLabour" class="form-control" placeholder="公司名称/联系人/地址" style="width: 240px;" oninput="search(this)" />
								</div>
								<div class="form-group">
									<button class="btn  btn-info" onclick="search('#adminFlag');">搜索</button>
								</div>
								<div class="form-group pull-right">
									<button type="button" onclick="openAddAdminView();" class="btn btn-block btn-info ">新建劳务公司</button>
								</div>
							</div>
						</div>
						<div class="box-body table-responsive">
							<table id="labourList" class="table  table-bordered table-hover">
								<thead>
									<tr>
										<th>公司名称</th>
										<th>公司logo</th>
		...
		<script src="../mcfish/js/labour/labour.js"></script>
	</body>
